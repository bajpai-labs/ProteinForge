...
export const Route = createFileRoute("/case-studies/")({
  head: () =>
    pageSocialHead({
      title: `Case Studies: AI Antibody & Protein Design Across Immunology, Oncology, Industrial | ${PRODUCT_NAME}`,
      description: `Three anonymized ProteinForge engagements: RSV F-protein neutralizing antibodies, HER2 bispecific T-cell engager design, and industrial enzyme thermostability engineering. Real validation data.`,
      canonical: `${SITE_ORIGIN}/case-studies`,
      ogTitle: `${PRODUCT_NAME} Case Studies`,
      ogDescription: `Real results from AI-powered antibody and protein design across immunology, oncology, and industrial biotech.`,
    }),
...
function CaseStudiesIndexPage() {
  return (
    <SiteLayout>
        ...
        <div className="section-inner relative z-10 py-20 lg:py-28">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-3 font-display text-4xl tracking-tight text-[var(--charcoal)] sm:text-5xl">
              Real programs.{" "}
              <span className="gold-gradient">Real validation data.</span>
            </h1>
            <p className="mt-5 max-w-2xl text-lg leading-relaxed text-muted-foreground">
              Client identities are anonymized at their request, but every metric below is from a
              closed engagement with downstream wet-lab expression and functional confirmation.
            </p>
      ...
      <PageSection
        eyebrow="By domain"
        title="Three programs across biologics modalities"
        description="Select a case study to read the full engagement timeline, ranked deliverables, validation outcomes, and lessons learned."
        tone="parchment"
      >
      ...
      <section className="section-inner pb-20">
        <div className="overflow-hidden rounded-3xl border border-border bg-[var(--charcoal-deep)] p-10 text-[var(--vellum)] sm:p-14">
          ...
          <p className="mt-4 max-w-xl text-[var(--vellum)]/75">
            Tell us about your antigen or protein engineering challenge. We will scope a 2 to 4 week pilot.
          </p>
